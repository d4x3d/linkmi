                ...
                <Dialog open={isWithdrawOpen} onOpenChange={setIsWithdrawOpen}>
                    ...
                    <DialogContent className="sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Transfer your earnings to your local bank account.
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        {!bankAccount ? (
                            ...
                            <div className="space-y-4 py-4">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        className="w-full p-2 rounded-md border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm"
                                ...
                                {resolvedAccountName && (
                                    <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-md flex items-center gap-2 text-green-700 dark:text-green-400">
                                        <div className="h-5 w-5 rounded-full bg-green-200 dark:bg-green-800 flex items-center justify-center text-xs font-bold">✓</div>
                                ...
                                <div className="border rounded-md p-3">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-xs text-neutral-500">{bankAccount.accountNumber} • {bankAccount.accountName}</p>
                                        </div>
                                ...
                                >
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-neutral-500">
                                            Customer: {maskEmail(purchase.customerEmail)}
                                        </p>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <div className="text-xs">
                                            <span
                                                className={`inline-block px-2 py-1 rounded-full ${purchase.status === "success"
